...
test('should be array with two objects about four properties]', () => {
  ...
  const expected = [
    {
      name: 'Двойной выстрел', id: 8, icon: 'http://...', description: 'Двойной выстрел наносит двойной урон',
    },
    {
      name: 'Нокаутирующий удар', id: 9, icon: 'http://...', description: 'Описание недоступно',
    },
